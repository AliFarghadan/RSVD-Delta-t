 ...
 * Copyright (c) 1991-2024, UChicago Argonne, LLC and the PETSc Development Team  (2-clause BSD license)
 * All rights reserved.

This product includes software from the Slepc toolkit (Slepc 3.18)
 * Copyright (c) 2002-2024, Universitat Politecnica de Valencia, Spain (2-clause BSD license)
