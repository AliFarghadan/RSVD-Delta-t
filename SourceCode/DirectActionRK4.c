...
PetscErrorCode DirectActionRK4(RSVD_matrices *RSVD, RSVDt_vars *RSVDt, LNS_vars *LNS, \
			DFT_matrices *DFT, Weight_matrices *Weight, Directories *dirs, TS_removal_matrices *TSR)
{
	/*
		...
		For a modified resolvent operator, it computes W_q_sqrt * C * R * B * W_f_sqrt_inv \times \hat{F} 
